...
public class Datasource {
	...
	public boolean open() {
		try {
			...
			System.out.println("Unexcepted problem occured ->" + e.getMessage());
			return false;
		}
	}
	...
	public List<String> queryAlbumsForArtist(String artistName, int sortOrder){
		...
		try(Statement statement = conn.createStatement();
			...
			System.out.println("Error happened in 112"+ e.getMessage());
			return null;
		}	
	}
	...
	public List<SongArtist> queryArtistsForSong(String songName, int sortOrder) {
		...
		try (Statement statement = conn.createStatement();
			...
			System.out.println("ERROR HAPPENED IN 150" + e.getMessage());
			return null;
		}
	}
	...
	public int getCount(String table) {
		...
		try(Statement statement = conn.createStatement();
			...
			System.out.println("Error in 172");
			return -1;
		}
	}
